...
.. warning::
    ...
    dataset. *Do not* store datasets under different GDPR data
    processing agreement in the same project or dataset. Similarly, do
    not place GDPR protected and non-GDPR protected data in the same
...
1. **Who should administer the project/dataset?** This person will be
...
2. **Who should have access to the project?** Who, other than the owner
   of the project or dataset, should be given access once it has been
   created?
3. **How much data do you expect to store?** UCPH-IT needs a rough
   ...
   100 TB.
4. **What is the name of the project?** This name will be used for the
...
5. **Will your project contain sensitive data?** You must let us know if
