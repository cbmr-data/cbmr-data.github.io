...
.. warning::
    ...
    controller. This is required for GDPR compliance. See the
...
- **My data is located on Esrum or on a network drive (H:, N:, S:)**
      ...
      - I want to :ref:`copy data to SIF or ERDA <s_transfers_sif_erda>`
...
- **My data is located somewhere else**
      - My :ref:`data is located on another UCPH cluster
        <s_sharing_projects>`
      - My :ref:`data is located on SIF or ERDA <s_transfers_sif_erda>`.
